        ...
        fun FieldsBody() {
            ...
            Surface(modifier = Modifier.fillMaxSize(), onClick = { focusManager.clearFocus() })
            {
                Column(
                    ...
                    val modifier = Modifier.padding(12.dp).fillMaxWidth()
...
//                    unfocusedIndicatorColor = Color.Transparent
        ...
        fun SecureTextField(
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(onNext = { focusManager.moveFocus(FocusDirection.Down) }),
                placeholder = { Text(text = "Entrez votre mot de passe") }, // = Watermark
                leadingIcon = {
                    Icon(
                        imageVector = Icons.Default.AccountBox,
                        contentDescription = null
...
//                    unfocusedIndicatorColor = Color.Transparent
        ...
        fun KotlinCoolSwitch(
            ...
            Row(
                ...
                Text(text = if (isKotlinCool) "Kotlin est cool !" else "Je préfère Java")
            }
        }
        ...
        fun AgeSlider(
            ...
            Column(
                ...
                Text(text = "Vous avez ${value.toInt()} ans")
            }
        }
