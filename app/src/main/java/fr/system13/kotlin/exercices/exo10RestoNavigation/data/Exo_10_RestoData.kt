...
class Exo_10_RestoDataService {
    ...
    val cheesecake = Exo_10_RestoItem(name = "Cheesecake citron Litchi", image = R.drawable.exo_10_resto_cheesecake)
    ...
    val mozzarella = Exo_10_RestoItem(name = "mozzarella", image = R.drawable.exo_10_resto_mozzarella)
    ...
    val americain = Exo_10_RestoMenu(name = "Américain", starter = nuggets, mainCourse = burger, dessert = sundae)
    ...
    val italien = Exo_10_RestoMenu(name = "Italien", starter = mozzarella, mainCourse = pizza, dessert = tiramisu)
